...
@include('admin.partials.pageTitle', ['title' => 'Create new skill'])
...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            @endif
            <!-- /.card-header -->
                <form class="form-horizontal" method="post" action="{{ route('skill.store') }}">
                    @csrf
                    <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="meta_name" id="meta_name"
                                               placeholder="Meta name" value="{{ old('meta_name') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="meta_value" id="meta_value"
                                               placeholder="Meta value %" value="{{ old('meta_value') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
